...
-- CreateEnum
CREATE TYPE "MediaRequestStatus" AS ENUM ('pending', 'fulfilled', 'missing', 'rejected', 'canceled');

-- CreateEnum
CREATE TYPE "UserActivityType" AS ENUM ('WATCHLISTED', 'LISTED', 'HIGH_RATED', 'PROGRESS');

-- CreateEnum
CREATE TYPE "RequestReason" AS ENUM ('WATCHLISTED', 'LISTED', 'HIGH_RATED', 'PROGRESS');
